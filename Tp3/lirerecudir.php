		...
		if($entree != "." && $entree != "..")
		{
			...
			//	echo "<br>".$entree."<br>";
                ...
                switch ($extension) {
                    ...
                    case 'txt':
                        echo " <p>ㅤㅤㅤㅤ <i class='far fa-file'></i> ".$entree."</p>";
                        break;
                    case 'html':
                        echo " <p>ㅤㅤㅤㅤ <i class='far fa-file-code'></i> ".$entree."</p>";
                        break;
                    default :
                    echo " <p>ㅤㅤㅤㅤ <i class='far fa-image'></i> ".$entree."</p>";
                    }
				//echo " ㅤㅤㅤ<a href=''>".$entree."</a><br>";
